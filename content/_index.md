...
<div class="w-full overflow-x-auto">
  <div style="font-size: clamp(24px, 4vw, 35px); white-space: nowrap; line-height: 1;white-space: nowrap;" class="inline-block min-w-full text-center font-bold">Systemic Medicine Doctor</div>
</div>
